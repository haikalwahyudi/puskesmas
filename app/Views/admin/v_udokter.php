                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="customRadio1" name="jk" checked value="Laki-Laki" <?php if ($data->jk == "Laki-Laki") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                    <label for="customRadio1" class="custom-control-label" required>Laki - Laki</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="customRadio2" name="jk" value="Perempuan" <?php if ($data->jk == "Perempuan") {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="old_poto" value="<?= $data->poto; ?>">
                                </div>
                            </div>
                            <div class="form-group">
